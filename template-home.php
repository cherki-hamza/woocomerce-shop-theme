			...
			<main>
				<section class="slider">
					<div class="flexslider">
					  <ul class="slides">
						...
						?>
						    <li>
						      <?php the_post_thumbnail( 'cherki_image_blog', array( 'class' => 'img-fluid' ) ); ?>
						      <div class="container">
				...
				?>
						...
						<section class="popular-products">
							...
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_popular_title', __( 'Popular products', 'cherki-dev' ) ) ); ?></h2>
								</div>
						...
						<section class="new-arrivals">
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_new_arrivals_title', __( 'New Arrivals', 'cherki-dev' ) ) ); ?></h2>
								</div>
						...
						<section class="deal-of-the-week">
							<div class="container">
								<div class="section-title">
									<h2><?php echo esc_html( get_theme_mod( 'set_deal_title', __( 'Deal of the Week', 'cherki-dev' ) ) ); ?></h2>
								</div>
